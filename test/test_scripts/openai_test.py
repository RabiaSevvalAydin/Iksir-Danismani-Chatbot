...
print("Openai modelinin Severus Snape karakteri için test sorularına cevapları toplanıyor...")
model_outputs_severus_openai = collect_model_outputs("..\\test_data\\potion_test_questions.json", retriever, llm, character="Severus Snape")

print("Openai modelinin Peri Anne karakteri için test sorularına cevapları toplanıyor...")
model_outputs_fairy_openai = collect_model_outputs("..\\test_data\\potion_test_questions.json", retriever, llm, character="Fairy Godmother")

# Performans değerlendirmesi - Model başına 45 saniye sürüyor
print("Openai modelinin Severus Snape karakteri için performansı değerlendiriliyor")
results_severus_openai = evaluate_model("..\\test_data\\potion_test_questions.json", model_outputs_severus_openai)

print("Openai modelinin Peri Anne karakteri için performansı değerlendiriliyor")
results_fairy_openai = evaluate_model("..\\test_data\\potion_test_questions.json", model_outputs_fairy_openai)
